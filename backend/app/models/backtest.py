...
class GeneratedStrategy(Base):
    """Strategies generated by the Strategy Coding Agent."""
    ...
    created_by_agent_run_id: Mapped[str | None] = mapped_column(String(64), nullable=True)

    __table_args__ = (
        Index("ix_generated_strategies_name", "name"),
        Index("ix_generated_strategies_active", "is_active"),
    )
